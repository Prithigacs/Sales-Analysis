...
(9, 8, 8, 2, 119.98),
(10, 9, 9, 1, 129.99); 
-- update a Customer's Email and Phone Number
UPDATE Customers
SET ContactEmail = 'newemail@example.com', PhoneNumber = '5551234567'
WHERE CustomerID = 1;
-- Update a Product's Price and Stock Quantity
UPDATE Products
SET UnitPrice = 899.99, StockQuantity = 45
WHERE ProductID = 1;
-- Update the Status of an Order
UPDATE Orders
SET OrderStatus = 'Delivered'
WHERE OrderID = 3;
-- Update Salesperson's Region and Phone Number
UPDATE Salesperson
SET Region = 'North-East', PhoneNumber = '555-1111'
WHERE SalespersonID = 1;
-- Update the Quantity and TotalAmount in an OrderDetail
UPDATE OrderDetails
SET Quantity = 2, TotalAmount = 1999.98
...
DELETE FROM Orders
WHERE OrderID = 9;
-- Delete an OrderDetail by OrderDetailID
DELETE FROM OrderDetails
WHERE OrderDetailID = 10;

-- Delete a Salesperson by SalespersonID
